        ...
        <div className="p-6 sm:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                <h2 className="text-xl font-semibold">{t("partner.how", "How it works")}</h2>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="mt-2 text-white/85 space-y-1">
                  <div>
                    <span className="opacity-70">{t("partner.address", "Address")}:</span> {store.address}
                  </div>
                  {store.hours && (
                    <div>
                      <span className="opacity-70">{t("partner.hours", "Opening hours")}:</span> {store.hours}
                    </div>
                  )}
                  {store.website && (
                    <div>
                      <span className="opacity-70">{t("partner.website", "Website")}:</span>{" "}
                      <a className="underline text-indigo-300" href={store.website} target="_blank" rel="noreferrer">
                        {store.website}
                      </a>
                    </div>
                  )}
                  {store.phone && (
                    <div>
                      <span className="opacity-70">{t("partner.phone", "Phone")}:</span> {store.phone}
                    </div>
                  )}
                </div>
              </section>
              ...
              <section>
                <h2 className="text-xl font-semibold">{t("partner.perks", "Perks")}</h2>
                <ul className="mt-2 list-disc list-inside space-y-1 text-white/90">
              ...
              <Link to="/partners" className="btn-outline-neutral">
                <span className="pill">
                  <span className="text-slate-200">{t("partner.back", "Back to partners")}</span>
                </span>
              </Link>
            </div>
          </div>
